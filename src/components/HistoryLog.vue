<template>
  <Overlay class="log-history">
    <template v-for="(historyLog, index) in dashboard.totalHistory">
      <div v-if="historyLog.length > 0" :key="index" class="log-table">
    ...
    <BaseButton class="yellow has-small-top-margin" @clicked="closeLog()">
      <span>
