  ...
  >
    ...
    <template v-if="role.id">
      ...
      <div class="mafia-status">
        <strong v-if="role.mafia" class="mafia-role">
          {{ $t("common.Mafia") }}
        </strong>
        <strong v-else-if="role.solo" class="solo-role">
          {{ $t("common.Solo") }}
        </strong>
        <strong v-else class="citizen-role">
          {{ $t("common.Citizen") }}
        </strong>
      </div>
      <div class="details-info">
        <div>
          ...
          <CharacterPower :mafia="role.mafia" :solo="role.solo" :power="role.power" />
        </div>
        <div>
          <span>
            {{ $t("rolesInfo.rarity") }}
