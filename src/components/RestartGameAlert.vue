<template>
  <div class="resetGameAlert">
    ...
    >
      ...
      />
      <template v-if="!resetGame">
        <p>
          {{ $t("god.resetText") }}
        </p>
        <BaseButton class="green " @clicked="resetSameGame()">
          <span>
            {{ $t("god.restartButton") }}
          </span>
        </BaseButton>
        <BaseButton class="danger" @clicked="toggleOverlay(false)">
          <span>
            {{ $t("god.cancelButton") }}
          </span>
        </BaseButton>
      ...
      <template v-else>
        ...
        <BaseButton class="green " @clicked="resetFactory()">
          <span>
            {{ $t("god.startButton") }}
          </span>
        </BaseButton>
