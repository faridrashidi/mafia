<template>
  ...
  >
    <p>
      کارت‌های حرکت آخر شامل: تغییرچهره، فرش‌قرمز، مسیرسبز، روزشانس، بخت‌واقبال، سرشماری، نبش‌قبر، وصیت، ذهن‌زیبا، دروغ‌سیزده، روزمحاکمه، بی‌خوابی، شلیک‌نهایی و افشای‌هویت
    </p>
    <p>
      می‌تونی به فرد خارج‌شده بگی یکی از گزینه‌های زیر رو انتخاب کنه حال بسته به کارت‌هایی که مد نظر داری خودت تصمیم بگیر کارت انتخابی اعمال می‌شه یا باید یک کارت دیگه انتخاب کنه
    </p>
    <div
      class="card-holder"
    >
